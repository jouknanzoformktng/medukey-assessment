  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        {/* Matrix Card */}
        <div className="bg-gray-50 rounded-lg p-8 mb-12 border border-gray-100 shadow-sm text-center">
          <h2 className="text-2xl font-bold text-foreground mb-6">Matris Enèji Ou</h2>
          <div className="flex flex-col md:flex-row justify-center items-center gap-6">
            <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 w-full md:w-1/2">
        ...
        <div className="mb-16">
          ...
          <div className="bg-white p-8 rounded-lg border border-gold/30 shadow-[0_4px_20px_rgba(212,160,23,0.08)]">
        ...
        <div className="bg-primary text-white rounded-lg p-10 text-center relative overflow-hidden shadow-2xl shadow-primary/20">
          ...
          <a 
            ...
            className="inline-block bg-gold text-white px-10 py-5 rounded-md text-xl font-bold hover:bg-gold-dark transition-all hover:scale-105 active:scale-95 shadow-lg relative z-10"
          >
